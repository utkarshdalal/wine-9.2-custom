...
{
    static const char *nls_dirs[] = { NULL, NLSDIR, "/data/data/com.utkarshdalal.PluviaGoldberg/files/rootfs/usr/local/share/wine/nls", "/data/data/com.utkarshdalal.PluviaGoldberg/files/rootfs/usr/share/wine/nls" };

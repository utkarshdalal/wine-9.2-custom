...
#else
    asprintf( &dir, "/data/data/com.utkarshdalal.PluviaGoldberg/files/rootfs/tmp/.wine-%u/server-%s", getuid(), tmp );
#endif
    return dir;
}
...
static int setup_config_dir(void)
{
    ...
    if (!mkdir( "dosdevices", 0777 ))
    {
        ...
        symlink( "/data/data/com.utkarshdalal.PluviaGoldberg/files/rootfs", "dosdevices/z:" );
    }
